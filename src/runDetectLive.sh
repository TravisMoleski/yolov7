...
# python3 detect.py --weights yolov7.pt --conf 0.25 --img-size 1120 --source ./video/04072023Uptown.mp4
python3 detect_live.py --input-fps 30 --weights  ./weights/yolov7.pt --conf 0.25 --img-size 1120 --source ./videos/OUVanUptownExample.mp4 --view-img
